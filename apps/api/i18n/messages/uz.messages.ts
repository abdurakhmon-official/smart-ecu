...
export const uz: Record<MessageCode, string> = {
  ...
  SERVICE_CATALOG_ITEM_NOT_FOUND: 'Xizmat turi topilmadi',
  SERVICE_PROVIDER_NOT_FOUND: 'Servis topilmadi',
  SERVICE_PROVIDER_ALREADY_EXISTS: 'Sizda allaqachon servis profili mavjud',
  SERVICE_OFFERING_NOT_FOUND: 'Xizmat taklifi topilmadi',
  ORDER_NOT_FOUND: 'Buyurtma topilmadi',
  ORDER_NOT_ACCEPTABLE: 'Bu buyurtma endi mavjud emas',
  ORDER_NOT_CANCELLABLE: 'Faqat yangi, hali qabul qilinmagan buyurtmani bekor qilish mumkin',
  ORDER_NOT_YOURS_TO_COMPLETE: 'Faqat buyurtmani qabul qilgan servis uni yakunlashi mumkin',
  ORDER_NOT_COMPLETED: 'Faqat yakunlangan buyurtmaga sharh qoldirish mumkin',
  REVIEW_ALREADY_EXISTS: 'Bu buyurtmaga allaqachon sharh qoldirilgan',
