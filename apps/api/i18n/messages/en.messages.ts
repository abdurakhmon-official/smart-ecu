...
export const en: Record<MessageCode, string> = {
  ...
  SERVICE_CATALOG_ITEM_NOT_FOUND: 'Service catalog item not found',
  SERVICE_PROVIDER_NOT_FOUND: 'Service provider not found',
  SERVICE_PROVIDER_ALREADY_EXISTS: 'You already have a service provider profile',
  SERVICE_OFFERING_NOT_FOUND: 'Service offering not found',
  ORDER_NOT_FOUND: 'Order not found',
  ORDER_NOT_ACCEPTABLE: 'This order is no longer available',
  ORDER_NOT_CANCELLABLE: 'Only a new, unaccepted order can be cancelled',
  ORDER_NOT_YOURS_TO_COMPLETE: 'Only the workshop that accepted this order can complete it',
  ORDER_NOT_COMPLETED: 'You can only review a completed order',
  REVIEW_ALREADY_EXISTS: 'This order has already been reviewed',
