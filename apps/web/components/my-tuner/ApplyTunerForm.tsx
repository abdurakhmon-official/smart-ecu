...
import { CreateTunerProfileInputSchema, type CreateTunerProfileInput } from '@repo/contracts';
import { Button } from '@/components/ui/Button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/Card';
import { FormField } from '@/components/ui/FormField';
import { Input } from '@/components/ui/Input';
import { Textarea } from '@/components/ui/Textarea';
import { useApplyAsTuner } from '@/hooks/use-my-tuner';
import { errorFrom } from '@/lib/errors';

export function ApplyTunerForm() {
  const t = useTranslations('myTuner');
  const apply = useApplyAsTuner();
  ...
  const {
    ...
    setError,
    formState: { errors },
  } = useForm<CreateTunerProfileInput>({ resolver: zodResolver(CreateTunerProfileInputSchema) });
